...
const exampleCard = {
    ...
    effects: {
        AnyPlayer: { money: -5, moveForward: 5 }
    }
};
...
const ageOfExpansionCards = [
    ...
    },
    {
        ...
        effects: [
            { type: 'ALLIANCE_OFFER' /* , properties...? */ }, 
            { type: 'TRADE_OFFER' /* , resource: 'any', amount: 5 */ } 
        ]
    },
    {
...
// Export the formatted cards
export const PURPLE_CARDS = formattedAgeOfExpansionCards;

// Function to create a special event Age of Resistance card styled like Monopoly Chance cards
function createAgeOfResistanceCard(card) {
    return {
        name: card.name,
        description: card.description,
        layout: {
...
const ageOfResistanceCards = [
    ...
    },
    {
        ...
        effects: [
            { type: 'ALLIANCE_OFFER' },
            { type: 'TRADE_OFFER' /* , resource: 'knowledge', amount: 5 */ } 
        ]
    },
    {
    ...
    },
    {
        ...
        effects: [
            { type: 'TRADE_OFFER' /* , swap: true, amount: 5 */ } 
        ]
    },
    {
...
export const BLUE_CARDS = formattedAgeOfResistanceCards;
...
export const CYAN_CARDS = formattedAgeOfReckoningCards;

// Function to create a special event Age of Legacy card styled like Monopoly Chance cards
function createAgeOfLegacyCard(card) {
    return {
        name: card.name,
        description: card.description,
        layout: {
...
// Generate formatted Age of Legacy cards
const formattedAgeOfLegacyCards = ageOfLegacyCards.map(createAgeOfLegacyCard);
export const PINK_CARDS = formattedAgeOfLegacyCards;

// Legacy export that can be removed once the new structure is working
export const SPECIAL_EVENT_CARDS = {
    purple: formattedAgeOfExpansionCards,
    blue: formattedAgeOfResistanceCards,
    cyan: formattedAgeOfReckoningCards,
    pink: formattedAgeOfLegacyCards
};